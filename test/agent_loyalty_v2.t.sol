...
contract AgentManagementIntegrationTest is RestaurantTest {
    ...
    //     address iqrContract = enhanced.agentIQRContracts(agent1,branchIds[0]);
    ...
    //     // Verify MeOS license
    //     MeOSLicense memory license = enhanced.getMeOSLicense(agent1,branchIds[0]);
    ...
    function test_UpdateAgent_Success() public {
        ...
        console.log("branchIds.length:",branchIds.length);
    ...
    function test_FullWorkflow_CompleteScenario() public {
        ...
        address loyalty1 = enhanced.agentLoyaltyContracts(agent1,branchIds1[0]);
        address loyalty2 = enhanced.agentLoyaltyContracts(agent2,branchIds2[0]);
        ...
        uint256 migratedAmount = enhanced.migrateLoyaltyTokens(agent1, agent2,branchIds1[0],branchIds2[0]);
        ...
        vm.prank(superAdmin);
        uint256 unlocked = enhanced.unlockLoyaltyTokens(agent2,branchIds2[0]);
