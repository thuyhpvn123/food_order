...
//         // Setup roles
//         loyalty.grantRole(admin, Role.Admin);
//         loyalty.grantRole(staff1, Role.Staff);
//         loyalty.grantRole(staff2, Role.Staff);
//     }
...
//         address newStaff = makeAddr("newStaff");
                
//         loyalty.grantRole(newStaff, Role.Staff);
        
//         Role role = loyalty.getRole(newStaff);
//         assertEq(uint8(role), 1); // Role.Staff
//     }
    
//     function testRevokeRole() public {        
//         loyalty.revokeRole(staff1);
        
//         Role role = loyalty.getRole(staff1);
//         assertEq(uint8(role), 0); // Role.None
//     }
