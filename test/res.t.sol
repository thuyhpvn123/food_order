...
import  "../contracts/order_demo_option.sol";
...
//         attendanceSystem.setBE(be);
    ...
    function SetUpDish()public {
        ...
        (DishOption[] memory allDishOptions) = MANAGEMENT.GetAllDishOptions();
          console.log("allDishOptions.maximumSelection:",allDishOptions[0].optionName);
        console.log("allDishOptions.maximumSelection:",allDishOptions[0].maximumSelection);
        //
        ...
        console.log("optionsDish1:",optionsDish1[0].optionName);
        console.log("optionsDish1:",optionsDish1[0].maximumSelection);
