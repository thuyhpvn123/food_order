...
//     bytes32[] public selectedFeatureIdsDish2; //3 muc do cay cua dish2_code
//     bytes32[] public selectedFeatureIdsDish3; //3 muc do cay cua dish3_code
//     constructor() {
...
//         featureNames1[0] = "Khong cay";
//         featureNames1[1] = "Cay vua";
//         featureNames1[2] = "Cay nhieu";
...
//         assertEq(totalCount,1,"dish options number should be equal");
//         selectedFeatureIdsDish1 = MANAGEMENT.getFeatureIdsAFromDishCode("dish1_code","Do Cay");
//         assertEq(selectedFeatureIdsDish1.length,3,"selectedFeatureIdsDish1 number should be equal");
//         selectedFeatureIdsDish2 = MANAGEMENT.getFeatureIdsAFromDishCode("dish2_code","Do Cay");
//         assertEq(selectedFeatureIdsDish2.length,3,"selectedFeatureIdsDish2 number should be equal");
//         selectedFeatureIdsDish3 = MANAGEMENT.getFeatureIdsAFromDishCode("dish3_code","Do Cay");
//         assertEq(selectedFeatureIdsDish3.length,3,"selectedFeatureIdsDish3 number should be equal");
...
//         dishSelectedOptions[1] = selectionOption1;
//         dishSelectedOptions[2] = selectionOption2;
